...
DOC_SUMMARIES = [
    ...
    },
    {
        ...
        "summary": [
            ...
            "הנתונים המרכזיים לאישור: שנת הקמה 1964, ח.פ. 520026113, כ-140 עובדים, 7,900 מ\"ר ייצור ומשרדים, 3,000 מ\"ר מרלו\"ג, תקני ISO 9001 ו-FSSC 22000.",
        ],
    },
    {
...
def add_brand_and_chrome(doc: Document, data: dict) -> None:
    ...
    add_table(
        ...
        [
            ...
            ["שנת הקמה", str(company["foundingYear"])],
