...
export const privacyDoc: Record<Lang, LegalDoc> = {
  he: {
    ...
    sections: [
      {
        ...
        list: [
          'מידע שאתה מוסר מרצונך — בעת פנייה אלינו או הגשת מועמדות למשרה דרך הטפסים באתר, אתה עשוי למסור שם מלא, מספר טלפון, כתובת דוא"ל, תוכן ההודעה וקובץ קורות חיים שתבחר לצרף.',
      ...
      },
      {
        ...
        body: [
          'איננו מוכרים ואיננו משכירים מידע אישי לצדדים שלישיים. מידע עשוי להימסר אך ורק במקרים הבאים: לספקי שירות הפועלים מטעמנו (כגון אירוח האתר ושירותי דוא"ל), המחויבים בשמירת סודיות ובשימוש במידע למטרת מתן השירות בלבד; כאשר הדבר נדרש לפי דין, צו שיפוטי או דרישת רשות מוסמכת; וכן במסגרת קבוצת דפוס בארי, ככל שהדבר נחוץ לטיפול בפנייתך.',
        ],
      },
      {
      ...
      },
      {
        heading: "אבטחת מידע",
        body: [
          "אנו נוקטים באמצעים סבירים לאבטחת המידע מפני גישה, שימוש או חשיפה בלתי מורשים. עם זאת, אין באפשרותנו להבטיח הגנה מוחלטת, ומסירת מידע ברשת האינטרנט נעשית באחריותך.",
        ],
      },
      {
        heading: "שמירת המידע",
        body: [
          "אנו שומרים את המידע למשך הזמן הנדרש למימוש המטרות שלשמן נאסף, או כפי שמתחייב לפי דין. מידע שנמסר במסגרת מועמדות למשרה עשוי להישמר לצורך בחינת התאמה למשרות עתידיות, אלא אם ביקשת את מחיקתו.",
        ],
      },
      {
        heading: "זכויותיך",
      ...
      },
      {
        ...
        body: [
          "האתר עשוי לכלול קישורים לאתרים של צדדים שלישיים. מדיניות פרטיות זו אינה חלה על אתרים אלה, ואיננו אחראים למדיניות הפרטיות או לתכנים שלהם. מומלץ לעיין במדיניות הפרטיות של כל אתר שאליו אתה נכנס.",
        ],
      },
      {
    ...
    contactIntro:
      "בכל שאלה, בקשה או פנייה בנוגע למדיניות הפרטיות או למידע המוחזק אודותיך, ניתן ליצור קשר:",
  },
  en: {
...
export const termsDoc: Record<Lang, LegalDoc> = {
  he: {
    ...
    intro: [
      ...
      "עצם הגישה לאתר והשימוש בו מהווים הסכמה מלאה לתנאים אלה. אם אינך מסכים לתנאי כלשהו, אנא הימנע מהשימוש באתר.",
    ],
    sections: [
      {
        heading: "אופי האתר",
      ...
      },
      {
        ...
        body: ["הינך רשאי לעשות באתר שימוש אישי ולא מסחרי בלבד. בין היתר, אינך רשאי:"],
        list: [
      ...
      },
      {
        ...
        body: [
          "בעת פנייה אלינו או הגשת מועמדות למשרה דרך האתר, הינך מתחייב כי הפרטים שמסרת נכונים ומדויקים. הגשת מועמדות או פנייה אינה מחייבת את החברה במתן מענה כלשהו או בהתקשרות. הטיפול במידע שנמסר כפוף למדיניות הפרטיות של החברה.",
        ],
      },
      {
        heading: "היעדר אחריות",
        body: [
          "האתר ותכניו מוצעים כפי שהם (\"AS IS\"). החברה אינה מתחייבת כי האתר יפעל ללא תקלות או הפרעות, או כי התכנים יהיו מדויקים, שלמים או עדכניים בכל עת. השימוש באתר נעשה על אחריותך בלבד. בכפוף לכל דין, החברה לא תישא באחריות לכל נזק, ישיר או עקיף, שייגרם משימוש באתר או מהסתמכות על תכניו.",
        ],
      },
      {
        heading: "קישורים לאתרי צד שלישי",
        body: [
          "האתר עשוי לכלול קישורים לאתרים חיצוניים שאינם בשליטת החברה. אין באמור משום אחריות או המלצה ביחס לאתרים אלה או לתכניהם, והשימוש בהם הוא באחריותך בלבד.",
        ],
      },
      {
