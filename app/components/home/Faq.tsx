          ...
          {items.map((item, i) => (
              <li key={item.n} className="border-b border-rule">
                ...
                <summary className="w-full flex items-center justify-between gap-4 sm:gap-8 md:gap-12 py-4 sm:py-5 md:py-6 lg:py-4 xl:py-6 text-start cursor-pointer focus-ring list-none [&::-webkit-details-marker]:hidden">
                  <span
                    aria-hidden
                    className="font-display text-magenta-deep text-[36px] sm:text-[56px] md:text-[80px] lg:text-[88px] xl:text-[96px] leading-[0.4] text-center tabular-nums w-[44px] sm:w-[80px] md:w-[110px] lg:w-[110px] xl:w-[120px] shrink-0 transition-colors duration-300 group-hover:text-ink"
                  >
                    {item.n}
                  </span>
                  ...
                  >
                    <span
                      className="absolute h-px w-4 sm:w-5 bg-current transition-transform duration-500 group-open:rotate-180"
                    />
                    <span
                      className="absolute h-px w-4 sm:w-5 bg-current transition-all duration-500 rotate-90 group-open:rotate-180 group-open:opacity-0"
                    />
                  </span>
                </summary>
