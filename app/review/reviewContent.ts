...
export const reviewPages: readonly ReviewPage[] = [
  ...
  // ---------------------------------------------------------------- about
  {
    ...
    sections: [
      ...
      {
        id: "about-standards",
        previewText: "איכות ללא פשרות",
        title: "תקנים והסמכות",
        summary: "הסעיף עבר לכאן מעמוד ההשבחות, והוא מוצג לפני קריאה לפעולה.",
        bullets: [
          'תיוג: "איכות מוכחת" · כותרת: "איכות ללא פשרות."',
          "פתיח: איכות היא מעבר לעמידה בדרישות — בקרה וניטור מבחירת חומרי הגלם ועד בדיקת המוצר המוגמר.",
          "ISO 9001:2015 — ניהול איכות. מוצגת סריקת התעודה וקישור לצפייה בה.",
          "FSSC 22000 — בטיחות מזון. מוצגת סריקת התעודה וקישור לצפייה בה.",
        ],
      },
      {
        id: "about-cta",
  ...
  // ---------------------------------------------------------------- finishing
  {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          "יכולות: השבחה דיגיטלית MGI · פויל חם/קר. (התקנים ISO 9001 ו-FSSC 22000 עברו לעמוד «אודות».)",
