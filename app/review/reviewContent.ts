    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "קישורי ניווט חוזרים + קישור LinkedIn.",
  ...
  // ---------------------------------------------------------------- about
  {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          'כותרת: "שותפות מנצחת".',
          "שמות לקוחות: Strauss · Osem · Tnuva · Elite · SodaStream · Moroccanoil · AHAVA · Dr. Fischer.",
          "(כרגע מוצגים כשמות טקסט עד שיתקבלו קובצי לוגו.)",
        ],
      },
      {
        id: "about-cta",
    ...
    sections: [
      {
        ...
        bullets: [
          ...
          "פתיח: אינדקס אריזות הקרטון הממותגות, מסודר לפי תעשייה — קוסמטיקה, פארמה, יין ומשקאות. מתכנון מבני ודיוק שטנץ ועד חומר, דפוס והשבחות.",
          "כרטיס מפרט: מפעל יבנה · פעיל משנת 1964 · מזהה BR-2026.",
        ],
      },
      {
      ...
      },
      {
        ...
        bullets: [
          "מארז שי ליין: קרטון קשיח לבקבוק יין עם תמיכה פנימית, שטנץ צורני והשבחות פויל ולכה. משקל 350 גרם · דוגמה תוך 24ש׳.",
          "מארז וויסקי פרימיום: חלון, פויל ולכה סלקטיבית עם תמיכה פנימית. אספקה 72ש׳ · תקן ISO 9001:2015.",
          "לכל פריט כפתור הורדת מפרט (PDF).",
        ],
        images: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "מפרט: סטייה ±0.01MM · שטנץ צורני · מבנה גרסה 02.",
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        title: "כותרת ופתיח",
        bullets: [
          'תיוג: "קריירה בבארי" · כותרת: "מצטרפים לעשייה".',
          "פתיח: הסטודיו, התכנון המבני, הדפוס והייצור עובדים תחת קורת גג אחת. כאן מתפרסמות המשרות הפתוחות לצד הצצה לעבודה היומיומית.",
          'שדה חיפוש משרה + כפתור "חיפוש".',
        ],
      },
      {
        id: "careers-articles",
        title: "כתבות והצצות (5 כרטיסים)",
        bullets: [
          'מקרה בוחן #023 (מרץ 2025): "מהצורך של הלקוח לאריזה שמוכנה לייצור" — כל פרויקט מתחיל בשאלה מה האריזה צריכה לעשות.',
          'איכות: "בקרת איכות" — בדיקות לאורך הייצור עומדות בתקני ISO 9001:2015 ו-FSSC 22000.',
          'ייצור: "דיוק בדפוס ובגימור".',
          'פיתוח: "מעבדת החומרים" — בדיקות חומר, שטנץ וקיפול.',
          'מבט מבפנים: "פרטים קטנים קובעים" — מילימטר בדייליין, גוון בדפוס וקו קיפול.',
        ],
        images: [
          {
            id: "careers-feature",
            src: "/images/figma/careers/feature.png",
            label: "תמונת מקרה הבוחן הראשי",
            alternatives: withCurrent("/images/figma/careers/feature.png", PACKAGING_SHOTS),
          },
          {
            id: "careers-materials",
            src: "/images/figma/careers/materials.png",
            label: "תמונת מעבדת החומרים",
            alternatives: withCurrent("/images/figma/careers/materials.png", PACKAGING_SHOTS),
          },
        ],
      },
      {
        ...
        bullets: [
          ...
          "#BR-402 — רכז/ת איכות · משרה מלאה · יבנה.",
          "#BR-409 — מבקר/ת איכות בייצור · משרה מלאה · יבנה.",
          "#BR-312 — מנהל/ת פרויקטים בייצור · משרה מלאה · יבנה.",
          'לכל משרה כפתור "להגשה".',
        ],
      },
      {
        id: "careers-newsletter",
        title: "עדכוני קריירה (הרשמה)",
        bullets: [
          'כותרת: "עדכוני קריירה".',
          "טקסט: רוצים לדעת כשנפתחת משרה חדשה? השאירו כתובת מייל ונעדכן.",
          'שדה אימייל + כפתור "הרשמה".',
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        bullets: [
          ...
          'הערה: "הכותרים הם דוגמאות — הפוסטים המלאים בעריכה."',
        ],
      },
      {
        id: "blog-list",
    ...
    sections: [
      {
        ...
        title: "פתיח הפוסט",
        bullets: [
          "קטגוריה: מגמות עיצוב · זמן קריאה: 6 דקות · פורסם 20.5.2026.",
    ...
    sections: [
      {
        ...
        title: "פתיח הפוסט",
        bullets: [
          "קטגוריה: תכנון מבני · זמן קריאה: 5 דקות · פורסם 12.5.2026.",
    ...
    sections: [
      {
        ...
        title: "פתיח הפוסט",
        bullets: [
          "קטגוריה: קיימות · זמן קריאה: 5 דקות · פורסם 28.4.2026.",
    ...
    sections: [
      {
        ...
        title: "פתיח הפוסט",
        bullets: [
          "קטגוריה: מהמפעל · זמן קריאה: 5 דקות · פורסם 9.4.2026.",
    ...
    sections: [
      {
        ...
        title: "פתיח הפוסט",
        bullets: [
          "קטגוריה: מהסטודיו · זמן קריאה: 5 דקות · פורסם 30.3.2026.",
    ...
    sections: [
      {
        ...
        title: "פתיח הפוסט",
        bullets: [
          "קטגוריה: תכנון מבני · זמן קריאה: 4 דקות · פורסם 18.3.2026.",
